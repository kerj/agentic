...
echo
echo "Next:"
echo "   1. Start host Ollama on all interfaces:  OLLAMA_HOST=0.0.0.0 ollama serve"
echo "   2. Bring it up:  docker compose --env-file docker/.env -f docker/docker-compose.yml up --build"
